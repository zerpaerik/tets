...
class EditWorkdayMReport extends StatefulWidget {
  static const routeName = '/new-workday';
  final User user;
  final int workday;
  List worker = List();
  List workerDescription = List();
  ...
  @override
  _EditWorkdayMReportState createState() =>
      _EditWorkdayMReportState(user, workday, worker, workerDescription);
}

class _EditWorkdayMReportState extends State<EditWorkdayMReport> {
  User user;
  int workday;
  List worker = List();
  List workerDescription = List();
  _EditWorkdayMReportState(
      this.user, this.workday, this.worker, this.workerDescription);
                        ...
                        children: <Widget>[
                          ...
                          Container(
                              ...
                              child: Align(
                                ...
                                child: Text(
                                  '${worker.length} Trabajadores seleccionados',
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 18,
                                  ),
