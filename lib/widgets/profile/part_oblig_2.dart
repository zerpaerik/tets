...
class ProfilePartOblig2 extends StatefulWidget {
  static const routeName = '/add-profile2';

  @override
  _ProfilePartOblig2State createState() => _ProfilePartOblig2State();
}

class _ProfilePartOblig2State extends State<ProfilePartOblig2> {
  GlobalKey<_ProfilePartOblig2State> signatureKey = GlobalKey();
        ...
        child: Form(
          ...
          child: ListView(
            children: <Widget>[
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration:
                          InputDecoration(labelText: 'Nº de dependientes'),
              ...
              if (_valName == null) ...[
                Container(
                  ...
                  child: DropdownButton(
                    // hint: Text("Contacto de Emergencia"),
                    underline: Container(
                      height: 1,
                      color: Colors.grey,
                    ),
              ...
              if (_valName != null && _valFirstName != null) ...[
                Container(
                    margin: EdgeInsets.only(left: 20, right: 20),
                    child: TextFormField(
                      // initialValue: _valName + ' ' + _valFirstName,
                      onTap: () {
                        _showInputDialog();
                      },
                      textAlign: TextAlign.left,
                      decoration: InputDecoration(
                          hintText: _valName + ' ' + _valFirstName),
                    )),
              ],
              Column(
                children: <Widget>[
