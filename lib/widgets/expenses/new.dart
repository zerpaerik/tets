...
class NewExpensesPage extends StatefulWidget {
  ...
  NewExpensesPage({@required this.user});

  @override
  _NewExpensesPageState createState() => _NewExpensesPageState(user);
}

class _NewExpensesPageState extends State<NewExpensesPage> {
  User user;
  _NewExpensesPageState(this.user);
  GlobalKey<_NewExpensesPageState> signatureKey = GlobalKey();
