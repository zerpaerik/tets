class ApiWebServer {
  static const server_name = 'http://emplooy.turpialdev.webfactional.com';
  //static const server_name='http://192.168.3.16:8000';
  ...
  static const API_AUTH_LOGIN = server_name + '/api/v-1/auth/login';
